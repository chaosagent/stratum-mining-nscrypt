...
COINDAEMON_ALGO = 'scryptn'    # The available options are:  scryptn, scrypt, sha256d, scrypt-jane, skeinhash, and quark
#SCRYPTJANE_NAME not needed for scryptn anymore.
